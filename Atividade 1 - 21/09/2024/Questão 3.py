...
stat, p = scipy.stats.shapiro(irisSetosaSepalWidth)# NORMAL (p-valor 0.205)
...
print(f"Resultado do teste de assimetria para o conjunto de dados da largura da pétala da espécie Iris-Setosa: {assimetricSetosaPetalWidth}") # resultado do teste: 1.1610221. Valor > 0 indicando cauda a direita.

# #Gráfico de histograma confirmando a cauda para a direita.

plt.hist(irisSetosaPetalWidth) # 0.1 e 0.6 são respectivamente os valores mínimo e máximo do conjunto.
...
# plt.hist(irisVersicolorPetalWidth, 8,(1.0,1.8)) # 1.8 e 1.8 são respectivamente os valores mínimo e máximo do conjunto.
...
plt.hist(irisSetosaPetalLength, 10,(1.0,1.9)) # 1.0 e 1.9 são respectivamente os valores mínimo e máximo do conjunto.
...
plt.hist(irisSetosaSepalLength,6, (4.3,5.8)) # 4.3 e 5.8 são respectivamente os valores mínimos e máximos do conjunto.
...
print(irisSetosaSepalWidth.min())
print(irisSetosaSepalWidth.max())
...
plt.hist(irisVersicolorPetalLength, 11)
...
plt.hist(irisVirginicaPetalWidth)
...
plt.hist(irisVirginicaSepalLength)
